<?php 
    if($roleId == 1){
        ...
        echo '
            <p class="title">ГЛАВНОЕ МЕНЮ</p>
            <a href="index.php" id="dashboard"><img src="/assets/images/dashboard.svg" alt="">Дашборд</a>
            <a href="metal-cad.php" id="metal-cad"><img src="/assets/images/pencil.svg" alt="">Гибка металла</a>
            <a href="index.php" id="dashboard-mobile" class="mobile_link"><img src="/assets/images/mobile_dashboard.svg" alt=""></a>
            <a href="metal-cad.php" id="metal-cad-mobile" class="mobile_link"><img src="/assets/images/mobile_pencil.svg" alt=""></a>
        ';
